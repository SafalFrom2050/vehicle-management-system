...
public class StaffPortalController implements ActionListener, ListSelectionListener {
    ...
    private void loadDefaultList(){
     ...
     private void loadVehicles(){
        ...
        uon.vehiclehiresystem.models.ListModel<Vehicle> vehicleListModel = new uon.vehiclehiresystem.models.ListModel<Vehicle>(vehicle.getVehiclesList());
     ...
     private void loadUsers(){
        ...
        uon.vehiclehiresystem.models.ListModel<Staff> staffListModel = new ListModel<Staff>(usersList);
    ...
    private void setHireRequestStatus(int status) {
        ...
        }else if(status == HiredVehicle.STATUS_APPROVED || status == HiredVehicle.STATUS_PENDING){
    ...
    private void queryUser(){
        ...
        if(user == null) user = Staff.getUserWithUsername(username);

        if(user == null){
            Messages.showErrorMessage("No user found with username: " + username, frameStaffPortal);
            return;
        }
