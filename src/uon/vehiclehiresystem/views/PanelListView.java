...
import uon.vehiclehiresystem.controllers.ListRenderer;
...
public class PanelListView extends JPanel {
    ...
    private uon.vehiclehiresystem.models.ListModel listModel;
    ...
    public PanelListView(uon.vehiclehiresystem.models.ListModel listModel, int width, int height, int userType){
    ...
    public void setListModel(uon.vehiclehiresystem.models.ListModel listModel) {
        this.listModel = listModel;
